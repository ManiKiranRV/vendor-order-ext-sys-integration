    ...
    */
    async ExpDhl(): Promise<any> {
        ...
        return new Promise(async (resolve, reject) => {
            try {
                ...
                //this.logger.log("tmsDataList",tmsDataList.res, tmsDataList.res.length)
                for (let i = 0; i <= tmsDataList.res.length; i++) {
                    ...
                    //this.logger.log("customerOrderNumber---------->",tmsDataList.res[i].dataValues.message.principalRef)
                    let customerOrderNumber = tmsDataList.res[i].dataValues.message.principalRef+"";
                    this.logger.log("customerOrderNumber",customerOrderNumber)
                   ...
                   // this.logger.log("Message", JSON.stringify(message));
                    ...
                    var result = await request(options, async (error: any, response: any) => {
                        ...
                        // this.logger.log(`Reponse from TMS system is ${response.body}`);
                        var expres = {
    ...
    async getAllExpTmsData(): Promise<any> {
        return new Promise(async (resolve, reject) => {
            let whereObj: any = {};
            try {
                //this.logger.log('Request Body inside ExpTmsService', req)
